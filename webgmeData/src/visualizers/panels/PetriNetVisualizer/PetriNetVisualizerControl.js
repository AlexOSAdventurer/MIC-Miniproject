...
define([
    ...
    PetriNetVisualizerControl.prototype._initializeToolbar = function () {
        ...
        this.$resetSimulation = toolBar.addButton({
            title: 'Reset Simulation',
            icon: 'gme icon-gme_diagonal-arrow',
            clickFn: function (data, checked) {
                self._logger.debug('Checkbox has been clicked!');
                self._widget.resetSimulation();
            }
        });
        this._toolbarItems.push(this.$resetSimulation);

        this.$netType = toolBar.addButton({
            title: 'Update Net Type Annotation',
            icon: 'gme icon-gme_pen',
            clickFn: function (data, checked) {
                self._logger.debug('Checkbox has been clicked!');
                self._widget.updateNetTypeDisplay();
            }
        });
        this._toolbarItems.push(this.$netType);
